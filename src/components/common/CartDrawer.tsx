                    ...
                    <div className="flex items-center justify-between mt-3">
                      ...
                      <div className="flex items-center border border-orea-champagne/30">
                        ...
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center text-orea-taupe hover:text-orea-dark transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
