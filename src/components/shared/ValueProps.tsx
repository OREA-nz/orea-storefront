  ...
  return (
    <>
      <button
        ...
        className={`flex flex-col items-center justify-center p-4 md:p-6 bg-transparent border border-orea-sand/50 hover:bg-orea-sand/20 transition-all gap-3 group text-center min-h-[120px] md:min-h-[140px]`}
      >
          ...
          >
            ...
            <div className="flex flex-col flex-1 p-8 md:p-12">
              <div className="mb-6 flex justify-center">
                <div className="w-10 h-10 flex items-center justify-center text-orea-earth [&_svg]:w-full [&_svg]:h-full">
                  {icon}
                </div>
              </div>
