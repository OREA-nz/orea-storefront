  ...
  return (
    <section className="relative h-[90vh] sm:h-screen w-full flex items-end justify-center overflow-hidden bg-orea-linen pb-10 md:pb-14">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src={settings.image} 
          alt="ORÉA Fine Jewellery — editorial hero" 
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-container mx-auto flex flex-col gap-8 animate-fade-in">
        <div className="flex flex-col items-center">
          <h1 className="font-serif text-[clamp(1.75rem,2.8vw,2.25rem)] text-orea-dark font-light tracking-[0.35em] sm:tracking-[0.45em] uppercase">
            {settings.heading}
          </h1>
        ...
        <div className="pt-2">
          <Link to={settings.button_link || '/collection'} className="group relative inline-block overflow-hidden w-full sm:w-auto text-center px-8 sm:px-10 md:px-12 py-4 border border-orea-dark/30 text-orea-dark text-caption tracking-[0.3em] sm:tracking-[0.4em] uppercase transition-all duration-700 hover:text-orea-cream hover:border-orea-dark">
