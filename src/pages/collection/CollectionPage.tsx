      ...
      <main className="max-w-wide mx-auto px-6 md:px-12 pb-section-xl">
        ...
        <div className="flex justify-between items-center mb-16 text-caption uppercase tracking-widest text-orea-dark/70 border-b border-orea-linen/40 pb-6">
          <div className="flex items-center gap-6">
            ...
            {searchQuery && (
              <span className="border-l border-orea-linen pl-6 font-medium opacity-80">
                Search: {searchQuery}
              </span>
            )}
          ...
          <div className="relative" ref={sortRef}>
            ...
            {isSortOpen && (
              <div className="absolute right-0 top-full mt-4 w-56 bg-orea-cream border border-orea-linen shadow-sm z-50 py-4">
        ...
        {/* Product Grid */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-16 md:gap-x-8 md:gap-y-20 lg:gap-x-12 lg:gap-y-24">
