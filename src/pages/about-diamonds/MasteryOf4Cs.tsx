...
export const MasteryOf4Cs: React.FC = () => {
  ...
  return (
    <section className="bg-[#F9F6F1] border-y border-orea-linen overflow-hidden">
        ...
        <div className="max-w-wide mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            <div className="flex flex-col gap-8 max-w-content">
              ...
              <div className="flex flex-col gap-3 border-t border-orea-linen pt-8">
        ...
        <div className="bg-[#F9F6F1] flex justify-center">
          {tabs.map((tab) => (
            <button
              ...
              className={`group flex-1 px-2 sm:px-5 md:px-8 py-4 transition-all relative flex flex-col items-center gap-2 ${
      ...
      <div className="max-w-wide mx-auto px-4 sm:px-8 lg:px-12 mt-4 mb-6 flex flex-col items-center gap-4">
...
const StandardSeal = ({ text }: { text: string }) => (
  <div className="pt-8 border-t border-orea-linen w-full max-w-sm mx-auto">
...
const CutChapter = () => (
  <div className="animate-reveal flex flex-col h-full">
    <div className="px-3 py-6 sm:px-4 sm:py-8 md:px-5 md:py-10 lg:px-6 lg:py-12 flex flex-col items-center gap-8 sm:gap-12">
      ...
      <div className="w-full max-w-content flex flex-col gap-1">
        <div className="w-full border-b-2 border-orea-dark grid grid-cols-5">
          {['EXCELLENT', 'VERY GOOD', 'GOOD', 'FAIR', 'POOR'].map((label, idx) => (
            <div key={idx} className="border-x border-orea-linen py-2 sm:py-4 text-center">
        ...
        <div className="grid grid-cols-3 gap-px bg-orea-linen mt-8">
          {[
            ...
            <div key={item.label} className="flex flex-col items-center gap-4 sm:gap-6 bg-orea-cream p-3 sm:p-6 md:p-8 group transition-colors duration-700">
